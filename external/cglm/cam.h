 ...
 * @brief set up view matrix
 *
 * convenient wrapper for lookat: if you only have moveDirection not target self
 * then this might be useful. Because you need to get target from moveDirection.
 *
 * NOTE: The UP vector must not be parallel to the line of sight from
 *       the eye point to the reference point
 *
 * @param[in]  eye    eye vector
 * @param[in]  dir    moveDirection vector
 * @param[in]  up     up vector
 * @param[out] dest   result matrix
 */
CGLM_INLINE
 ...
 * @brief set up view matrix
 *
 * convenient wrapper for look: if you only have moveDirection and if you don't
